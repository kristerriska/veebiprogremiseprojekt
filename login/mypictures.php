...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="#" class="w3-bar-item w3-button-active w3-hide-small w3-padding-large w3-large w3-theme-d4"><i class="fa fa-photo w3-margin-right"></i>Minu Pildid</a>
  <a href="myprofile.php" class="w3-bar-item w3-button-active w3-hide-small w3-padding-large w3-large w3-hover-white"><i class="fa fa-user-circle w3-margin-right"></i>Minu Kasutaja</a>
 </div>
</div>
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
		...
		<div class="w3-row-padding" style="margin:0 -16px">
			<?php 
				...
				$photosFromDatabase->userUploadedImg($_SESSION["user"]);

			?>
		</div>
		<a href="#" type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-trash-o w3-margin-right"></i>Kustuta pilte</a>
      </div> 
